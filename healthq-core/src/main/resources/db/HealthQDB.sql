...
(
    ...
    constraint clinic_rooms_clinics_fk
        foreign key (clinics_id) references healthq.clinics (id)
);
...
(
    ...
    constraint patient_queues_clinic_rooms_fk
        foreign key (clinic_rooms_id) references healthq.clinic_rooms (id),
   	constraint patient_queues_doctors_fk
        foreign key (doctors_id) references healthq.doctors (id)    
);
...
(
    ...
    constraint patient_queue_requests_patients_fk
        foreign key (patients_id) references healthq.patients (id),
   	constraint patient_queue_requests_patient_queues_fk
        foreign key (patient_queues_id) references healthq.patient_queues (id)    
);